...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-emerald-900 lg:translate-x-0 lg:static lg:inset-0 flex flex-col h-full">

    <div
        class="flex items-center justify-center h-16 bg-emerald-950 border-b border-emerald-800 shadow-md flex-shrink-0">
