    ...
    <div x-data="{
        ...
        pages: [
            @foreach ($pages as $page)
            {
                ...
                // Gradient digunakan untuk Garis Atas & Ring Avatar
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-8 items-stretch md:items-center mt-6">
            ...
            <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                <div class="relative w-full md:w-[180px]">
                    <select x-model="sortBy" class="block w-full pl-4 pr-10 py-3 text-base border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 sm:text-sm rounded-xl bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 shadow-sm transition-all cursor-pointer hover:border-gray-300 dark:hover:border-gray-600">
                ...
                <div class="group bg-white dark:bg-gray-800 rounded-2xl shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] border border-gray-100 dark:border-gray-700 hover:border-emerald-500/30 hover:shadow-lg dark:hover:shadow-emerald-900/10 transition-all duration-300 relative overflow-hidden flex flex-col">
                    ...
                    <div class="p-5 flex flex-col flex-1">
                        ...
                        <div class="absolute top-4 right-4 z-10" x-data="{ open: false }">
                            <button @click="open = !open" @click.away="open = false" class="p-1.5 text-gray-300 hover:text-gray-600 dark:hover:text-gray-200 rounded-lg transition-colors">
                            ...
                            <div x-show="open" 
                                ...
                                <button @click="copyToClipboard(page.url); open = false" class="w-full text-left px-3 py-2 text-xs font-medium text-gray-600 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-700 flex items-center gap-2">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3"></path></svg>
                                    Salin Link
                                </button>
                                <div class="h-px bg-gray-100 dark:bg-gray-700 my-1"></div>
                                <form :action="page.delete_url" method="POST" onsubmit="return confirm('Yakin hapus?')">
                                    @csrf @method('DELETE')
